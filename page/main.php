...
<head>
    ...
    <title>ALICE New Zealand 구매대행</title>
            ...
            <div class="container">
                ...
                <nav class="nav-menu mobile-menu">
                    <ul>
                        ...
                        <li><a href="./shop.html">뉴질랜드 제품</a></li>
                        <li><a href="./blog.html">My Page</a></li>
                        <li><a href="./contact.html">주문조회</a></li>
                    </ul>
                </nav>
                ...
                <div class="col-lg-3">
                    <div class="footer-left">
                        <div class="footer-logo">
                            ...
                            <h5 style="color:#fff;">ALICE NZ</h5>
                        </div>
                        <ul>
                            <li>Phone: +64 21.0886.0160</li>
                            <li>Email: mocaming@gmail.com</li>
                        </ul>
